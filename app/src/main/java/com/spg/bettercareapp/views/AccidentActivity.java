...
public class AccidentActivity extends AppCompatActivity {
    ...
    public void insertData() {
        ...
        Call<List<RowChangeModel>> call = apiInterface.setAccident(date, Integer.toString(id), note.getText().toString());
        call.enqueue(new Callback<List<RowChangeModel>>() {
            ...
            public void onResponse(Call<List<RowChangeModel>> call, Response<List<RowChangeModel>> response) {
                ...
                Toast.makeText(AccidentActivity.this, "Saved Successfully", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<List<RowChangeModel>> call, Throwable t) {
                Log.d("Fluid Activity","Failed");
                Toast.makeText(AccidentActivity.this, "Saved Failed", Toast.LENGTH_SHORT).show();
            }
        });
    }
}